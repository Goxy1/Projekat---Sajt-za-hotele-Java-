...
@WebServlet(name = "AtlantisAddTypeOfRoomFirstSlotServlet", value = "/AtlantisAddTypeOfRoomFirstSlotServlet")
public class AtlantisAddTypeOfRoomFirstSlotServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            response.sendRedirect("../ManagerPages/AddTypeOfRoomSuccessFirstSlot.jsp");
    ...
    private void insertTypeOfRoomIntoDatabase(String typeOfRoom) throws SQLException {
        String insertQuery = "UPDATE hoteli SET TypeOfRoom = ? WHERE ID = 1";
