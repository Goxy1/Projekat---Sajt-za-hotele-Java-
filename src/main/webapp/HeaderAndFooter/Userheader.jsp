      ...
      <div class = "col-md-10">
        <header>
          <div class = "page-header">
            <h1><a href = "../UserPages/ExploreHotelsUserPage.jsp"><img src = "../img/logo.jpg" alt="Logo nase kompanije"></a><small>Online reservation hotels </small></h1>
          </div>
        </header>
      </div>
    </header>
  ...
  <div class="container">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="d-flex"  method="GET" action="../SearchHotelsServlet">
